...
def twiCode():
    ...
    def atmMenu():
        ...
        while True:
            ...
            try:
                transaction = int(input("1) Shw3 wo sika a aka  2) Yi sika  3) Mobile Money  99) Gyae / Log Out\n \n"))
...
# LANGUAGE SELECTOR
print ("########################################### WELCOME TO TECH SEALS ATM #####################################################\n \n")
while True:
    try:
        print ("Select a language to continue\n \n")
        languageSelect = int(input('1) ENGLISH  2) ASANTE TWI   99) QUIT\n \n'))

        if languageSelect == 1:
            englishCode()
        

        elif languageSelect == 2:
            twiCode()

        elif languageSelect == 99:
            print("""
                -----------------------------------------
                | Thank you for choosing Tech Seals Bank |
                |         Visit us again!                |
